...
from .utils import FileLock, FileUtils, HealthMonitor, StateManager
...
async def main():
    ...
    try:
        ...
        results = await scanner.scan_project(progress_callback=progress_update)
        print("\nScan completed successfully!")
        print(f"Results saved to runtime/reports/")
