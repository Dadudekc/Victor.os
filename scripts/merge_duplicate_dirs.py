...
class DuplicateDirectoryFinder:
    ...
    def should_ignore(self, path: str) -> bool:
        ...
        return any(re.match(pattern, path.split('/')[-1]) for pattern in self.ignore_patterns)
        ...
        try:
            for root, _, files in os.walk(dir_path):
                ...
                for file in files:
                    ...
                    # Add key filenames
                    if file in ['__init__.py', 'README.md', 'setup.py', 'pyproject.toml']:
        ...
        for _, dir_group in similar_names:
            ...
            if similarity_scores:
                self.duplicate_groups.append(DuplicateGroup(
                    ...
                    duplicate_dirs=[d for d in duplicates if d in similarity_scores],
