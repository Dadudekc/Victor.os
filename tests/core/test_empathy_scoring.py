...
from src.dreamos.core.empathy_scoring import EmpathyScorer, WEIGHTS, CONFIG
...
class TestEmpathyScorer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.ethos_patcher = patch('src.dreamos.core.empathy_scoring.open', 
    ...
    def test_decay_half_life_effect(self, mock_get_logs):
        ...
        self.assertGreater(
            score_fast_decay["trend"]["overall"], 
            score_slow_decay["trend"]["overall"]
        )
    ...
    def test_get_agent_comparisons(self, mock_calculate_score):
        ...
        self.assertEqual(comparison["category_leaders"]["core_values"]["agent_id"], "agent-2")
    ...
    def test_determine_agent_status(self):
        ...
        for score, expected_status in statuses:
            self.assertEqual(self.scorer._determine_agent_status(score), expected_status)
    ...
    def test_weights(self):
        ...
        self.assertGreater(
            WEIGHTS["violation_severity"]["low"],
            WEIGHTS["violation_severity"]["high"]
        )
