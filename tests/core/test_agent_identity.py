...
class TestAgentIdentity(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_ethos = {
            "version": "1.1.0",
            "core_values": {
                "compassion": {"definition": "Prioritize user wellbeing and autonomy"},
                "clarity": {"definition": "Promote understanding and transparency"},
            },
        ...
        self.ethos_patcher = patch(
            "src.dreamos.core.agent_identity.open",
    ...
    def test_update_empathy_score_first_time(self):
        ...
        args, kwargs = (
            self.mock_devlog_instance.format_and_write_identity_update.call_args
        )
