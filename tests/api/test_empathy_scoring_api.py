...
from src.dreamos.api.empathy_scoring import router, update_score_cache, scorer, score_cache
...
class TestEmpathyScoringAPI(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.scorer_patch = patch.object(
            scorer, 'calculate_agent_score', 
            return_value=self.sample_score
        )
        ...
        self.all_scores_patch = patch.object(
            scorer, 'calculate_all_agent_scores',
        ...
        self.update_cache_patch = patch('src.dreamos.api.empathy_scoring.update_score_cache')
    ...
    def test_get_empathy_threshold_status(self):
        ...
        with patch.object(
            scorer, '_determine_system_status',
