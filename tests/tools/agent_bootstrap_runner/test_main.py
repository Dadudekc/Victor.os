...
class TestMainAsync:
    ...
    async def test_successful_run(
        ...
        monkeypatch.setattr(
            "dreamos.tools.agent_bootstrap_runner.__main__.AgentBus",
            lambda: mock_bus
        )
        monkeypatch.setattr(
        ...
        monkeypatch.setattr(
            "dreamos.tools.agent_bootstrap_runner.__main__.agent_loop",
            mock_agent_loop
        )
...
class TestMain:
    ...
    def test_successful_run(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "dreamos.tools.agent_bootstrap_runner.__main__.main_async",
            mock_main_async
        )
