...
class ImprovementValidator:
    ...
    def _validate_tests(self, tests: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        return {
            ...
            "details": {"test_count": len(tests), "test_results": tests},
        }
    ...
    def _validate_documentation(self, documentation: Dict[str, Any]) -> Dict[str, Any]:
        ...
        missing_fields = [
            field for field in required_fields if field not in documentation
        ]
    ...
    def _validate_implementation(
        ...
        missing_fields = [
            field for field in required_fields if field not in implementation
        ]
    ...
    def _validate_demonstration(self, demonstration: Dict[str, Any]) -> Dict[str, Any]:
        ...
        missing_fields = [
            field for field in required_fields if field not in demonstration
        ]
