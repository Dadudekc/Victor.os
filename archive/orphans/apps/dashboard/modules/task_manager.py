...
def update_task_status(
    agent_id: str, task_id: str, status: str, inbox_base: Path
) -> None:
...
def requeue_task(
    agent_id: str, task_id: str, target_agent: str, inbox_base: Path
) -> None:
...
def escalate_to_thea(
    agent_id: str, task_id: str, inbox_base: Path, thea_handler
) -> None:
        ...
        try:
            ...
            if task:
                ...
                if isinstance(thea_messages, list):
                    ...
                    asyncio.create_task(
                        thea_handler.handle_escalation(agent_id, task_id, escalation)
                    )
        except Exception as e:
