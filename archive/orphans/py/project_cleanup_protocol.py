...
class ProjectCleanupProtocol:
    ...
    def load_analysis(self) -> Tuple[Dict, Dict]:
        """Load and parse the project analysis files."""
        with open(self.analysis_file) as f:
            analysis_data = json.load(f)
            analysis = analysis_data.get("analysis_details", {})
    ...
    def calculate_file_utility_score(self, file_data: Dict) -> float:
        ...
        try:
            ...
            # Import count penalty (too many imports might indicate complexity)
        ...
        for file_data in analysis.values():
            ...
            for imp in file_data.get("imports", []):
                if isinstance(imp, str):
                    referenced_files.add(imp.replace(".", "/"))
    ...
    def log_cleanup_action(self, file_path: str, action: str, reason: str) -> None:
        ...
        try:
            ...
            print(f"Warning: Failed to log cleanup action: {e}")
    ...
    def run_cleanup_cycle(self) -> Tuple[bool, List[str]]:
        ...
        for func, locations in duplicates.items():
            ...
            implementations = [(loc, analysis[loc].get("complexity", 0)) for loc in locations]
    ...
    def run_until_clean(self, max_cycles: int = 10) -> List[str]:
        ...
        while cycle < max_cycles:
            cycle += 1
            print(f"Running cleanup cycle {cycle}...")
            ...
            if is_clean:
                ...
                print("Reached maximum cleanup cycles.")
            else:
                print(f"Project still needs cleaning. Moving to cycle {cycle + 1}...")
...
def main():
    ...
    protocol = ProjectCleanupProtocol(os.getcwd())
