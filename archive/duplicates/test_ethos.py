...
def test_validate_action_non_compliant(validator):
    ...
    action = {"type": "decision", "context": {}, "impact": "high", "confidence": 0.9}
...
def test_human_centricity_check(validator):
    ...
    action = {"type": "decision", "confidence": 0.9}
...
def test_uncertainty_handling_check(validator):
    ...
    action = {"type": "action", "confidence": 0.9}
...
def test_ethical_boundaries_check(validator):
    ...
    action = {"type": "data_access", "consent_verified": True}
...
def test_ethos_structure_validation(validator):
    ...
    # Invalid structure
    invalid_ethos = {"version": "1.0.0", "last_updated": datetime.now().isoformat()}
