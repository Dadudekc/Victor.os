...
if __name__ == "__main__":
    ...
    absolute_input_path = os.path.join(workspace_root, "sandbox/ironvale_feedback", INPUT_LOG_PATH)
    absolute_output_path = os.path.join(workspace_root, "sandbox/ironvale_feedback", OUTPUT_PAYLOAD_PATH)
    ...
    simulated_log_data = {
        ...
        "timestamp_end_utc": (datetime.datetime.now(datetime.timezone.utc) + datetime.timedelta(seconds=2)).isoformat(),
