...
from ..prompts import DNA_ANALYSIS_PROMPT
    ...
    def __init__(self, memory: AgentMemory):
        ...
        self.trait_definitions = {
            'empathy': {
                ...
                'indicators': ['emotional_understanding', 'compassion', 'perspective_taking']
            },
            'adaptability': {
            ...
            'creativity': {
                ...
                'indicators': ['solution_novelty', 'lateral_thinking', 'experimentation']
            },
            'resilience': {
            ...
            'collaboration': {
                ...
                'indicators': ['team_coordination', 'knowledge_sharing', 'conflict_resolution']
            },
            'efficiency': {
            ...
            'learning': {
                ...
                'indicators': ['skill_improvement', 'feedback_integration', 'knowledge_acquisition']
            }
        }
        ...
        self.pattern_categories = {
            ...
            'problem_solving': ['solution_exploration', 'error_handling', 'optimization_attempts'],
                ...
                'traits': [
                    {
                        'name': trait,
                        'value': score,
                        'trend': await self._calculate_trait_trend(agent_id, trait, score),
