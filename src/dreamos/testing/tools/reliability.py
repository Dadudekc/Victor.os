"""
Tool reliability testing framework for Dream.OS.

This module provides a comprehensive framework for testing and validating
the reliability of core tools within Dream.OS, with initial focus on
read_file and list_dir operations that have been identified as critical
blockers to autonomous operation.
"""
