...
class ProjectScanner:
    ...
    def __init__(
        ...
        self.cache = ProjectCache(cache_path=self.cache_path) if self.use_cache else None
    ...
    def _resolve_path_from_config(self, config_path_attr: Optional[Path | str], default_path: Path, description: str) -> Path:
        ...
        try:
            ...
            logger.error(f"Failed to create parent directory for {description} path {path_to_use}: {e}")
