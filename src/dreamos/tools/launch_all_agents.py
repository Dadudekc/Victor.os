...
# Constants
AGENTS = [f"Agent-{n}" for n in range(9)]  # 0-8 inclusive
...
class AgentProcess:
    ...
    def restart(self) -> bool:
        ...
        try:
            ...
            logger.info(f"Restarted {self.agent_id} (attempt {self.restart_count}/{MAX_RESTARTS})")
            return True
