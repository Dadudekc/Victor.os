...
class CommandPattern(InteractionPattern):
    ...
    def __init__(self, command_words: List[str], handler: Callable):
        ...
        super().__init__(
            name="command",
            description="Direct command interaction pattern"
        )
...
class ConversationalPattern(InteractionPattern):
    ...
    def __init__(self):
        ...
        super().__init__(
            name="conversational",
            description="Natural language conversation pattern"
        )
...
class QueryPattern(InteractionPattern):
    ...
    def __init__(self):
        ...
        super().__init__(
            name="query",
            description="Question answering pattern"
        )
        self.question_starters = [
            "what", "when", "where", "who", "why", "how", "can", "could", 
            "would", "will", "is", "are", "do", "does"
        ]
...
class InteractionManager:
    ...
    def _handle_system_command(self, input_text: str, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if "activate" in input_lower or "start" in input_lower:
            ...
            return {
                ...
                "content": "JARVIS activated and ready." if success else "Failed to activate JARVIS.",
                "success": success,
                "bypass_core": True
            }
            ...
            return {
                "type": "system_response",
                "content": "JARVIS deactivated." if success else "Failed to deactivate JARVIS.",
                "success": success,
                "bypass_core": True
            }
            
        elif "status" in input_lower:
            system_state = self.jarvis._get_system_state() if self.jarvis.is_active else {"status": "inactive"}
            return {
                "type": "system_response",
