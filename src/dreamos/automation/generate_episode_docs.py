...
class EpisodeDocGenerator:
    ...
    def generate_markdown(self) -> str:
        ...
        md_lines.extend([
            ...
            "### Thresholds",
            "```yaml",
            yaml.dump(self.episode_data['self_regulation_hooks']['thresholds'], default_flow_style=False),
            "```",
            "\n### Behaviors",
            "```yaml",
            yaml.dump(self.episode_data['self_regulation_hooks']['behaviors'], default_flow_style=False),
            "```"
        ])
        ...
        for agent, info in self.episode_data['agent_awareness']['agent_prefixes'].items():
            md_lines.append(f"| {agent} | {info} | {self.episode_data['agent_awareness']['config_file']} |")
        ...
        md_lines.extend([
            ...
            "\n### Reflection Template",
            "```yaml",
            yaml.dump(self.episode_data['digital_empathy']['template'], default_flow_style=False),
            "```"
        ])
    ...
    def save_documentation(self) -> bool:
        ...
        output_path = self.output_dir / f"episode-{self.episode_data['episode']['number']}.md"
