...
from basicbot.utils import logger, get_historical_data

# API Credentials
api = tradeapi.REST(Config.ALPACA_API_KEY, Config.ALPACA_SECRET_KEY, Config.BASE_URL, api_version="v2")
...
from basicbot.utils import logger, get_historical_data, retry_api_call
